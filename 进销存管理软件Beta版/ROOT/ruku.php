...
{       
    ...
    {  
        alert('<?php echo $TEXT['alert-empty-jinhuojiage'];?>');  
          
        return false; 
    } 
	if (document.myform.shuliang.value=="")  
    {  
        alert('<?php echo $TEXT['alert-ruku-shuliang'];?>');  
          
        return false; 
    } 
	if (document.myform.date.value=="")  
    {  
        alert('<?php echo $TEXT['alert-jinhuo-riqi'];?>');  
...
document.getElementById("c02").className = "active01";
...
<form action="include/ruku.php" method="post" name="myform" onSubmit="return Check()">
<div class="rightTop">
...
<img src="images/ico/2.gif"  style="vertical-align:middle;"/>&nbsp;<?php echo $TEXT['commodity-in'];?></td>
<td width="15">
...
<div class="rightText"><?php echo $TEXT['purchase-price'];?>：<input name="jiage" class="cssInput"></div>
<div class="rightText"><?php echo $TEXT['quantity-storage'];?>：<input name="shuliang" class="cssInput"></div>
<div class="rightText"><?php echo $TEXT['purchase-date'];?>：<input name="date" class="cssInput" value="<?php echo date('Y-m-j');?>"></div>
