...
<img src="images/ico/2.gif"  style="vertical-align:middle;"/>&nbsp;<?php echo $TEXT['in-records'];?></td>
<td width="15">
...
<td width="150px;"><?php echo $TEXT['purchase-price'];?></td><td width="150px;"><?php echo $TEXT['quantity-storage'];?></td>
<td width="250px;"><?php echo $TEXT['purchase-date'];?></td></tr>
<?php					
$sql="select * from zy_spruku order by id asc";
