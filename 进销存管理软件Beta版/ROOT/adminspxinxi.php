...
<img src="images/ico/2.gif"  style="vertical-align:middle;"/>&nbsp;<?php echo $TEXT['manage-commodity-information'];?></td>
<td width="15">
...
<td width="400px;"><?php echo $TEXT['commodity-name'];?></td><td width="200px;"><?php echo $TEXT['opt'];?></td></tr>
<?php					
$sql="select * from zy_spxinxi order by id asc";
$result=mysql_query($sql);
while($rs=mysql_fetch_object($result)){
$id=$rs->id;
$name=$rs->name;                   
?>
<tr height="40px;"><td width="300px;"><?php echo $name ;?></td><td width="150px;"><a href="upspxinxi.php?id=<?php echo $id ;?>"><?php echo $TEXT['modify'];?>
</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="include/delspxinxi.php?id=<?php echo $id ;?>"><?php echo $TEXT['delete'];?></a></td></tr>
<?php
}
?>
</table>
