...
<div class="cont_top_title"><?php echo $TEXT['commodity-inventory'];?></div>
</div>
<div class="sale">
<?php	
include("../conn/conn.php");			
$sql="select * from zy_spkucun order by id desc";
...
?>
<div class="sale_list">
<div class="sale_list_list"><?php echo $TEXT['commodity-name'];?>：<?php echo $rowSp["name"];?></div>
<div class="sale_list_list"><?php echo $TEXT['commodity-inventory'];?>：<?php echo $row["kucun"];?></div>
</div>
<?php
}
?>
