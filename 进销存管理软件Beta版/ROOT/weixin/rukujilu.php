...
<div class="cont_top_title"><?php echo $TEXT['in-records'];?></div>
</div>
<div class="sale">
<?php	
include("../conn/conn.php");			
$sql="select * from zy_spruku order by id desc";
...
<div class="sale_list_list"><?php echo $TEXT['purchase-price'];?>：<?php echo $row["jiage"];?></div>
<div class="sale_list_list"><?php echo $TEXT['quantity-storage'];?>：<?php echo $row["shuliang"];?></div>
<div class="sale_list_list"><?php echo $TEXT['purchase-date'];?>：<?php echo $row["date"];?></div>
</div>
<?php
}
?>
